...
function RecepcionistAulaMagnaUCR() {
    ...
    const scheduledEvents = {
        'Marimba de Concierto de Bellas Artes, Guatemala': {
            description: 'Disfruta de la tradicional Marimba de Concierto de Bellas Artes desde Guatemala.',
            schedule: '10 de diciembre de 2024, 7:00 PM',
        },
        'Concierto de la Orquesta Sinfónica UCR': {
            description: 'Un concierto especial lleno de interpretaciones clásicas y contemporáneas.',
            schedule: '15 de diciembre de 2024, 8:00 PM',
        },
        'Campanas de Gratitud, Hermandad y Regocijo': {
            description: 'Un espectáculo lleno de música y espíritu festivo.',
    ...
    return (
        <div className="receptionist-view">
            ...
            <h2>Vista del Recepcionista - Aula Magna UCR</h2>
...
export default RecepcionistAulaMagnaUCR;