...
function RecepcionistCentroArtesUNA() {
    ...
    const scheduledEvents = {
        'Ballet La Bella y la Bestia': {
            description: 'Un clásico del ballet con magníficos movimientos y música.',
            schedule: '10 de diciembre de 2024, 7:00 PM',
        },
        'BALLET EL CASCANUECES 2024': {
            description: 'El Cascanueces, una tradición navideña con música de Tchaikovsky.',
            schedule: '15 de diciembre de 2024, 6:00 PM',
        },
        'GIRA VICTORIA-RAPHAEL': {
            description: 'Raphael nos trae su gira "Victoria" llena de emoción y éxitos.',
    ...
    useEffect(() => {
        ...
        const storedAttendees = localStorage.getItem('attendeesCentroArtesUNA') || '{}';
    ...
    const markAttendance = (code) => {
        ...
        localStorage.setItem('attendeesCentroArtesUNA', JSON.stringify(updatedAttendees));
    };
    ...
    return (
        <div className="receptionist-view">
            ...
            <h2>Vista del Recepcionista - Centro de Artes UNA</h2>
