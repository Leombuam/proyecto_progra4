...
function RecepcionistTeatroNacional() {
    ...
    const scheduledEvents = {
        'Concierto de Año Nuevo': {
            description: 'Celebra el nuevo año con la Orquesta Sinfónica Nacional.',
            schedule: '1 de enero de 2025, 6:00 PM',
        },
        'Obra de Teatro "La Casa de Bernarda Alba"': {
            description: 'Una obra maestra de Federico García Lorca presentada en el Teatro Nacional.',
            schedule: '10 de enero de 2025, 7:00 PM',
        },
        'Ballet "El Lago de los Cisnes"': {
            description: 'Disfruta del ballet clásico en una noche inolvidable.',
            schedule: '15 de enero de 2025, 8:00 PM',
        },
    };

    useEffect(() => {
        setEvents(Object.entries(scheduledEvents));
        const storedAttendees = localStorage.getItem('attendeesTeatroNacional') || '{}';
    ...
    const markAttendance = (code) => {
        ...
        localStorage.setItem('attendeesTeatroNacional', JSON.stringify(updatedAttendees));
    };
    ...
    return (
        <div className="receptionist-view">
            ...
            <h2>Vista del Recepcionista - Teatro Nacional</h2>
...
export default RecepcionistTeatroNacional;